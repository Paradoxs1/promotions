...
class SilpoParser extends Parser
{
    ...
    {
        $url = [
            'https://silpo.ua/offers/cina-tizhnya',
            'https://silpo.ua/offers/akciyi-vlasnogo-importu',
            'https://silpo.ua/offers/garyacha-propoziciya',
            'https://silpo.ua/offers/tematichni-tizhni',
            'https://silpo.ua/offers/dityachi-tizhni',
            'https://silpo.ua/offers/other'
        ];
        $start = 0;
        $end = 100;

        foreach ($url as $u) {
            $this->SilpoShop($u, $start, $end);
        }
